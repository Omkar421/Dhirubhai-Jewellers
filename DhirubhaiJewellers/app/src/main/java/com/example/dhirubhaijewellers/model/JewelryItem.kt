...
object LocalDataSource {
    val items = listOf(
        JewelryItem(1, "Bridal Gold Necklace", "Gold", "₹1,45,000", "22k Pure Gold traditional bridal set.", R.drawable.gold),
        ...
        JewelryItem(4, "Kundan Set", "Silver", "96,300", "Sterling Silver handcrafted mens kada", R.drawable.silver_kundan),
        JewelryItem(5, "AD Set", "Silver", "15,000", "Sterling Silver handcrafted mens kada.", R.drawable.silver_ad),
